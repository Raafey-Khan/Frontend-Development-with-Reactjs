document.addEventListener("DOMContentLoaded", async () => {
  ...
  async function fetchProducts() { // fetching the products from the api
  ...
  async function fetchProductsByCategory(category) { // fetching the products by category using another api
    // and using a query params
  ...
  async function fetchCategories() { // simple api call of categories no query parms here
...
async function downloadContentAndPopulate () {
    // till the time we downloading the content
    // from the api , then the loader comes up
